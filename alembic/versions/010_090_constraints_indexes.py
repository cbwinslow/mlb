"""Apply 090_constraints_indexes layer SQL files.

Revision ID: 010_090_constraints_indexes
Revises: 009_080_functions
...
revision = "010_090_constraints_indexes"
down_revision = "009_080_functions"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sql_root = pathlib.Path(__file__).parent.parent.parent / "sql" / "090_constraints_indexes"
