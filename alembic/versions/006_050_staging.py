"""Apply 050_staging layer SQL files.

Revision ID: 006_050_staging
Revises: 005_040_raw
...
revision = "006_050_staging"
down_revision = "005_040_raw"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sql_root = pathlib.Path(__file__).parent.parent.parent / "sql" / "050_staging"
