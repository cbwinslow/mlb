"""Apply 060_core layer SQL files.

Revision ID: 007_060_core
Revises: 006_050_staging
...
revision = "007_060_core"
down_revision = "006_050_staging"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sql_root = pathlib.Path(__file__).parent.parent.parent / "sql" / "060_core"
